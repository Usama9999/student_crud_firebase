...
public class update_srudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Key=getIntent().getStringExtra("option");
        Toast.makeText(update_srudent.this, "key: "+Key, Toast.LENGTH_SHORT).show();
        ...
        reference.child(Key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    Toast.makeText(update_srudent.this, "value: "+dataModel, Toast.LENGTH_SHORT).show();
    ...
    public void updateStudent(View view) {
        ...
        reference.child(Key).updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(update_srudent.this, "Updated Successfully!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void goBackToHome(View view) {
        Intent intent=new Intent(update_srudent.this,MainActivity.class);
